...
function createManyPeople() {
  const arrayOfPeople = [
    { name: "nizar", age: 28, favoriteFoods: ["Sushi", "burritos"] },
    { name: "thamer", age: 27, favoriteFoods: ["burritos", "Ice Cream"] },
    { name: "ala", age: 31, favoriteFoods: ["burritos", "Pizza"] },
    { name: "thamer", age: 28, favoriteFoods: ["Burger", "burritos"] },
    { name: "abbes", age: 28, favoriteFoods: ["Tacos", "Pizza"] },
    { name: "amal", age: 28, favoriteFoods: ["burritos", "Pasta"] },
